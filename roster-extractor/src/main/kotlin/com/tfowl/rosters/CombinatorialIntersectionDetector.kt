...
class IntersectionGridAlignment(val tolerance: Double) {
    ...
    data class AlignmentInfo(val horizontals: SortedSet<Double>,
                             val verticals: SortedSet<Double>)

    private fun alignOnAnAxis(intersections: List<PdfLineIntersection>,
                              axisAccessor: Point2D.() -> Double,
                              axisSetter: Point2D.(Double) -> Unit): SortedSet<Double> {
